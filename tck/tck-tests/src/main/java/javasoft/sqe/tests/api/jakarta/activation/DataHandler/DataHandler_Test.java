...
@Test
public void testDataHandlerTest1()
{
    Status s = dataHandlerTest1();
...
@Test
public void testDataHandlerTest2()
{
    Status s = dataHandlerTest2();
    assertEquals(Status.PASSED, s.getType(), "Status " + s);
}
...
@Test
public void testDataHandlerTest3()
{
    Status s = dataHandlerTest3();
    assertEquals(Status.PASSED, s.getType(), "Status " + s);
}
...
@Test
public void testDataHandlerTest4() throws IOException
{
    Status s = dataHandlerTest4();
    assertEquals(Status.PASSED, s.getType(), "Status " + s);
}
...
@Test
public void testDataHandlerTest5() throws IOException
{
    Status s = dataHandlerTest5();
    assertEquals(Status.PASSED, s.getType(), "Status " + s);
}
